<?php
// Fichier /fonct/fonct.php
// Contient les fonctions pour les pages : index.php & statistiques.php
...
function affichematch($idM)
{
    ...
    foreach ($result as $row) {
        ...
        echo '</td>';
        echo '<td>';
        echo '<img src="' . $row['drapeau1'] . '" width="50"/>' . '<br>' . $row['p1'];
        echo '</td>';
        echo '<td>';
        echo '<img src="' . $row['drapeau2'] . '" width="50"/>' . '<br>' . $row['p2'];
        echo '</td>';
        echo '<td>';
        echo $row['scoreA'];
        echo ' - ';
